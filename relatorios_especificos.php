    ...
    <div class="results-container table-container">
        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 10px;">
            ...
            <?php if ($report_type == 'pilotos' && !empty($resultados)): ?>
                <a href="gerar_pdf_pilotos.php?<?php echo http_build_query($_GET); ?>" target="_blank" class="button" style="background-color: #c0392b; color: white; text-decoration: none; padding: 8px 12px; border-radius: 5px;">
