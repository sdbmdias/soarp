...
if ($isPiloto) {
    ...
    // 2. Busca apenas os pilotos do mesmo CRBM
    ...
    // Administradores veem todos os pilotos
...
<body>
    <div class="sidebar">
        <ul>
            ...
            <li><a href="listar_pilotos.php" class="active"><i class="fas fa-users"></i> Pilotos</a></li>
        ...
        <div class="table-container">
            <table class="data-table">
                ...
                <tbody>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="<?php echo $isAdmin ? '8' : '5'; ?>">Nenhum piloto cadastrado.</td>
                        </tr>
                    <?php endif; ?>
                </tbody>
            </table>
