...
<head>
    ...
    <style>
        ...
        .sidebar{width:250px;background-color:#2c3e50;color:#fff;padding-top:20px;box-shadow:2px 0 5px rgba(0,0,0,.1);display:flex;flex-direction:column;align-items:center;transition: transform 0.3s ease; z-index: 1001;}
        ...
        .sidebar ul li .submenu.open{max-height:500px}
        .main-content{flex-grow:1;padding:20px;background-color:#f0f2f5;color:#333;overflow-y: auto;}
        .main-content h1{color:#2c3e50;margin-bottom:20px}
        .success-message-box,.error-message-box{padding:15px;border-radius:5px;text-align:center;font-weight:700;margin-bottom:20px;width:100%;max-width:700px;margin-left:auto;margin-right:auto;box-shadow:0 2px 5px rgba(0,0,0,.1);opacity:1;transition:opacity .5s ease-out 3s}
        ...
        .form-container, .table-container {background-color: #fff;padding: 20px;border-radius: 8px;box-shadow: 0 4px 15px rgba(0,0,0,.1);max-width: 100%;margin: auto;overflow-x: auto;}
        ...
        .data-table th, .data-table td {padding: 12px 10px;border-bottom: 1px solid #eee;text-align: center;color: #555;font-size: .9em;vertical-align: middle;}
        .data-table th{background-color:#f8f8f8;font-weight:700;color:#2c3e50}
        .data-table tbody tr:hover{background-color:#f5f5f5}
        .action-buttons a{display:inline-block;padding:5px 10px;margin: 2px;border-radius:4px;text-decoration:none;color:#fff;font-size:.85em}
        ...
        .user-role-display {padding: 15px 20px;text-align: center;color: #bdc3c7;font-size: 14px;line-height: 1.4;border-top: 1px solid #4a627a;width: 100%;box-sizing: border-box;}
        ...
        @media (max-width: 768px) {
            ...
            .mobile-header .page-title { font-size: 18px; color: #fff; margin: 0; }
